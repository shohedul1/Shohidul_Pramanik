...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex  items-center justify-center rounded-[30px] xl:bg-white text-muted-foreground dark:bg-white",
      className
    )}
    {...props}
  />
