...
const TypeWriter = () => {
    ...
    return (
        ...
        <>
            ...
            >
                <div className="relative w-full bg-white dark:bg-gray-800 dark:text-white text-black p-1 rounded-xl z-10">
                    <div
                        className="text-lg font-bold  w-full md:h-[150px] h-[190px]  border rounded-md "
